...
class Dependency(models.Model):
    abstract_activity = models.ForeignKey('AbstractActivity', on_delete=models.CASCADE, related_name = 'abstract_activity')
    dependency_activity = models.ForeignKey('AbstractActivity',on_delete=models.CASCADE, related_name='dependency_activity')

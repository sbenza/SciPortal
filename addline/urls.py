...
url(r'^addExpLine/$', views.addExpLine, name='addExpLineView'),
# url(r'^addLine/$', views.addLine, name='addLine'),
url(r'^(?P<explineid>[0-9]+)/addELAct/$', views.addELActView, name='addELAct'),
url(r'^(?P<explineid>[0-9]+)/addAbstractWkf/$', views.abstractWkfManagementView, name='addAbstractWkf'),
# url(r'^$', views.addAbstractWkfView, name='addAWkf'),
# url(r'^addELActivity/$', views.addELActivity, name='addELActivity'),
url(r'^(?P<explineid>[0-9]+)/addAbstractWkf/(?P<workflowid>[0-9]+)/$', views.derivationManagementView, name='addWkfAct'),
